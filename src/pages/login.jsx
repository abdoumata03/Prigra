...
//   }, []);
  ...
  return (
    <div className="flex flex-row items-center h-full font-eudox">
      <div className="2xl:w-1/2 w-full 2xl:mt-[0px] mt-[51px] flex flex-col items-center">
        <div className="flex flex-col items-center ">
          <img src={logo} alt="logo" className="pb-[20px] w-[137px]" />
          <h1 className="text-2xl mb-[66px] font-semibold text-gray1">
        ...
        <div>
          <form onSubmit={handleSubmit(submitForm)} className="flex flex-col">
            ...
            <p className="font-bold mb-[14px] mt-[25px] text-gray2">
              Mot de passe*
            </p>
            <input
              {...register("password")}
            ...
            <br />
            <div className="flex flex-col items-center">
              <button className="w-2/3 h-[55px] bg-primary mt-[60px] mb-[30px] rounded-[5px] text-white font-semibold">
                Continue
              </button>
            </div>
          </form>
