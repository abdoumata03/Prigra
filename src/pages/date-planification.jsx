...
const schema = yup.object().shape({
  ...
  fin_phase1: yup
    ...
    .test(
      "fin_phase1",
      "Fin de phase doit être postérieure au début de phase.",
      function(value) {
  ...
  debut_phase2: yup
    ...
    .test(
      "debut_phase2",
      "La deuxième phase débute après la fin de la précédente.",
      function(value) {
  ...
  debut_phase3: yup
    ...
    .test(
      "debut_phase3",
      "La troisième phase débute après la fin de la précédente.",
      function(value) {
  ...
  debut_phase4: yup
    ...
    .test(
      "debut_phase4",
      "La dernière phase débute après la fin de la précédente.",
      function(value) {
  ...
  return (
    <div className="w-5/6 mt-10 flex flex-col">
      <div className="w-4/6">
        ...
        <h2 className="text-sm font-normal text-gray3 mb-6">
          Optimisez l'organisation et la progression des projets grâce à une
        ...
        >
          <h1 className="text-gray-700 font-medium text-lg mt-10 mb-5">
            Période de soumission des projets
          </h1>
          ...
          <div className="flex flex-row gap-10">
            <div className="w-1/2">
              <p className="            text-xs font-medium text-gray3 mb-1">
                Début
              </p>
              <input
          ...
          <h1 className="text-gray-700 font-medium text-lg mt-10 mb-5">
            Période de validation des projets après recours
          </h1>
          <div className="flex flex-row gap-10">
            <div className="w-1/2">
              <p className="text-xs font-medium text-gray3 mb-1">Début</p>
