...
const Deliberation = () => {
  const { projectData, userInitialData, userData } = useContext(ProfileContext);
  ...
  return (
    <>
      <Breadcrumbs />
      {!deliberationData || !userData?.project_id ? (
          ...
          <div className="flex w-full gap-3">
            ...
            <div>
              <p className="text-gray2 text-sm">
                Vous n'etes pas encore délibiré
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          <h1 className="text-xl text-primary font-bold mb-2 ml-4">
            Félicitation !
          </h1>
          <h2 className="text-gray2 text-sm mb-5 ml-4">
            Voici votre résultat de déliberation :
          </h2>
          <div className="flex gap-10 items-center">
            <div className="w-1/3 flex flex-col bg-white rounded-[0.4rem] border py-4 px-6 shadow-custom">
              <div className="flex flex-col divide-y divide-dashed">
                <div className="flex">
                  <div className="py-3 text-gray2 flex items-center"></div>
